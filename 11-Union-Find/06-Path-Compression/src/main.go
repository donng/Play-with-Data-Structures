...
import (
	"Play-with-Data-Structures/11-Union-Find/06-Path-Compression/src/UF"
	"Play-with-Data-Structures/11-Union-Find/06-Path-Compression/src/UnionFind3"
	"Play-with-Data-Structures/11-Union-Find/06-Path-Compression/src/UnionFind4"
	"Play-with-Data-Structures/11-Union-Find/06-Path-Compression/src/UnionFind5"
	"fmt"
	"math/rand"
	"time"
)
