...
func (t *SegmentTree) Set(index int, e interface{}) {
	if index < 0 || index > len(t.data) {
		panic("Index is Illegal")
	}

	t.data[index] = e
	t.set(0, 0, len(t.data)-1, index, e)
}

func (t *SegmentTree) set(treeIndex int, l int, r int, index int, e interface{}) {
	if l == r {
		t.tree[treeIndex] = e
		return
	}
...
func Constructor(nums []int) NumArray {
	...
	segTree := GetSegmentTree(data, func(i interface{}, j interface{}) interface{} {
		return i.(int) + j.(int)
	})
